    ...
    return (
        <section className="bg-black py-20 lg:py-32">
            <div className="max-w-[1400px] mx-auto px-5 lg:px-20 text-center">
                ...
                <h2 className="text-white text-3xl lg:text-5xl font-semibold tracking-tight mb-6">
                    Ready to build
                    <br />
                    something great?
                </h2>

                <p className="text-gray-400 text-sm lg:text-base mb-16 max-w-2xl mx-auto leading-relaxed">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-16">
                    {/* Email Card */}
                    <Link href="mailto:hello@example.com" className="group">
